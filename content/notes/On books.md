...
Here are some thoughts about books as an information medium.
...
"Interesting 🤨.." - I thought. "Why?" - I asked not giving a second to my peer to follow up with the same question. (I listen more since that time).

The answer was simple: "On a daily basis you deal with challenges you need to respond to fast, so no time for books. I read only articles". 
...
- builds a complex mental model overall. Longer text format allows more information to flow in, so more complex models can appear in your mind.
- builds a mental model at the reader pace. A part of that is the ability to stop without a significant mental effort (to let the neurons connect, thus a mental model form). *Both online and hard copy books are good here.*
